...
const PHOTOS = {
  victoriaFalls: "https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=800&q=80",
  ...
  chobe: "https://images.unsplash.com/photo-1551632811-561732d1e306?w=800&q=80",
  nshima: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80",
  crafts: "https://images.unsplash.com/photo-1521913626209-0fbf68f4c4b1?w=800&q=80",
  waterfall: "https://images.unsplash.com/photo-1433086966358-54859d0ed716?w=800&q=80",
};
...
function OnboardingScreen({ onComplete }) {
  ...
  return (
    <div style={{ minHeight: "100vh", position: "relative" }}>
      <img src={PHOTOS.africaSunset} alt="" style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 70px)" }}>
      <div style={{ position: "relative", height: 130, flexShrink: 0, overflow: "hidden" }}>
        <img src={PHOTOS.africaSunset} alt="Guide" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
  ...
  return (
    <div style={styles.screen}>
      <div style={{ position: "relative", height: 190, overflow: "hidden" }}>
        <img src={PHOTOS.africaSunset} alt="Profile" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
